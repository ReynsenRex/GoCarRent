                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="mb-6 bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                        ...
                        <form method="GET" action="{{ route('admin.bookings.index') }}" class="grid grid-cols-1 md:grid-cols-4 gap-4">
                            ...
                            <div class="flex items-end space-x-2">
                                ...
                                <a href="{{ route('admin.bookings.index') }}" class="bg-gray-500 hover:bg-gray-600 text-white px-4 py-2 rounded-lg font-medium transition duration-200">
                                    Reset
                                </a>
                            </div>
                        </form>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-6 gap-4 mb-6">
                        ...
                        <div class="bg-yellow-100 dark:bg-yellow-900 p-4 rounded-lg">
                            ...
                            <p class="text-2xl font-bold text-yellow-600 dark:text-yellow-400">{{ \App\Models\Booking::where('status', 'pending')->count() }}</p>
                        </div>
                        <div class="bg-green-100 dark:bg-green-900 p-4 rounded-lg">
                            <h4 class="font-semibold text-green-800 dark:text-green-200 text-sm">Approved</h4>
                            <p class="text-2xl font-bold text-green-600 dark:text-green-400">{{ \App\Models\Booking::where('status', 'approved')->count() }}</p>
                        </div>
                        <div class="bg-purple-100 dark:bg-purple-900 p-4 rounded-lg">
                            <h4 class="font-semibold text-purple-800 dark:text-purple-200 text-sm">In Progress</h4>
                            <p class="text-2xl font-bold text-purple-600 dark:text-purple-400">{{ \App\Models\Booking::where('status', 'in_progress')->count() }}</p>
                        </div>
                        <div class="bg-gray-100 dark:bg-gray-700 p-4 rounded-lg">
                            <h4 class="font-semibold text-gray-800 dark:text-gray-200 text-sm">Completed</h4>
                            <p class="text-2xl font-bold text-gray-600 dark:text-gray-400">{{ \App\Models\Booking::where('status', 'completed')->count() }}</p>
                        </div>
                        <div class="bg-red-100 dark:bg-red-900 p-4 rounded-lg">
                            ...
                            <p class="text-2xl font-bold text-red-600 dark:text-red-400">{{ \App\Models\Booking::whereIn('status', ['cancelled', 'rejected'])->count() }}</p>
                        </div>
                    </div>
