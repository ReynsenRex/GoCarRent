<x-app-layout>
    <div class="max-w-4xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        ...
        <form method="POST" action="{{ route('admin.promos.update', $promo->id) }}"
            ...
            @csrf
            @method('PUT') {{-- penting untuk HTTP method PUT --}}
            ...
            <div>
                ...
                <textarea name="description" id="description" rows="3"
                    class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">{{ old('description', $promo->description) }}</textarea>
            </div>
            ...
            <div>
                ...
                <input type="number" name="discount_pct" id="discount_pct" required min="1" max="100"
                    value="{{ old('discount_pct', $promo->discount_pct) }}"
                    class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">
            </div>
